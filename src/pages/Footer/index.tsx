                ...
                <div className={styles.list}>
                    ...
                    <Container>
                        <ul>
                            ...
                            <li><Link to='/computer-centres'>Computer Centres</Link></li>
                            <li><Link to='/training-workshops'>Training Workshops</Link></li>
                            <li><Link to='/external-workshops'>External Training Workshops</Link></li>
                            <li><Link to='/sdp'>Student Development Platform (SDP)</Link></li>
                        </ul>
                    </Container>
                    <Container>
                        <ul>
                            <li><strong>Events</strong></li>
                            <li><Link to='/cyberia'>Cyberia</Link></li>
                            <li><Link to='/creation'>CREATION</Link></li>
                            <li><Link to='/chariteach'>charITeach</Link></li>
                        </ul>
                    </Container>
                    <Container>
                        <ul>
                    ...
                    <Container className={styles.img}>
                        <a href="https://facebook.com/NUSSUcommIT/"><Image src='/src/images/facebook.png'></Image></a>
                    </Container>
                </div>
            </div>

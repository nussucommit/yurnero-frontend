...
const Overview = () => {
  ...
  if ((trainingWorkshopData as ContentItem[]).length !== 0) {
    trainingWorkshopContentDisplay = convertContentItems(trainingWorkshopData as ContentItem[] as ContentItem[])
  }
  if ((elevateCreativityData as ContentItem[]).length !== 0) {
    elevateCreativityContentDisplay = convertContentItems(elevateCreativityData as ContentItem[] as ContentItem[])
  }
  if ((computerCenterData as ContentItem[]).length !== 0) {
    computerCenterContentDisplay = convertContentItems(computerCenterData as ContentItem[] as ContentItem[])
  }
    ...
    <div className={styles.Overview}>
      <div className={styles.Section}>
        <div className={styles.Content}>
          <Container>
            <p className={styles.HomeHeader}>TRAINING WORKSHOP</p>
            {isLoadingTW ? (
              <CircularProgress
                isIndeterminate
                color="blue.300"
        ...
        <Container>
          <Image src={require('../../images/home-trainingworkshop.jpeg')}></Image>
        </Container>
      </div>
      ...
      <div className={styles.Colordiff}>
        <div className={styles.Section}>
          <Container>
            <Image src={require('../../images/home-elevatethecreativity.jpeg')}></Image>
          </Container>
          <div className={styles.Content}>
            <Container>
              <p className={styles.HomeHeader}>ELEVATE THE CREATIVITY</p>
              {isLoadingEC ? (
                <CircularProgress
                  isIndeterminate
                  color="blue.300"
      ...
      <div className={styles.Section}>
        <div className={styles.Content}>
          <Container>
            <p className={styles.HomeHeader}>STUDY, PRINT OR SCAN</p>
            {isLoadingCC ? (
              <CircularProgress
                isIndeterminate
                color="blue.300"
        ...
        <Container>
          <Image src={require('../../images/home-studyprintscan.jpeg')}></Image>
        </Container>
      </div>
    </div>
  )

          ...
          <div className={styles.Nav}>
            <div key={idx}>
              <div className={styles.NavTitle}>
                <button className={styles.NavButtonTitle} onClick={() => navigate(nav.path)}>
                  {nav.title}
                </button>
                {nav.subNav.length > 0 && (
                  <div className={styles.NavButtonDropdownIcon}>
                    <ChevronDownIcon />
                  </div>
                )}
              </div>
            ...
            {nav.subNav.length > 0 && (
              <div className={styles.SubNavs}>
                {nav.subNav.map(subNav => (
                  <div>
                    <button className={styles.SubNavButtonTitle} onClick={() => navigate(subNav.path)}>
                      {subNav.title}
                    </button>
                  </div>
                ))}
